...
public class solicitudbecas extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (numcontrl2.getText().equals("") || numcontrl3.getText().equals("") || jComboBox1.getSelectedItem().equals("Seleccione") || numcontrl1.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Hay Uno o Varios Campos Vacios", "ERROR", JOptionPane.ERROR_MESSAGE);
            } else if (Integer.parseInt(numcontrl3.getText()) < 1) {
                JOptionPane.showMessageDialog(null, "El Campo De Promedio No Puede Ser Negativo", "ERROR", JOptionPane.ERROR_MESSAGE);
            } else if (Integer.parseInt(numcontrl3.getText()) > 10) {
    ...
    private void numcontrl2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numcontrl2KeyTyped
        try {

            if (numcontrl2.getText().length() == limitecontrol) {
                evt.consume();
                getToolkit().beep();
    ...
    }//GEN-LAST:event_numcontrl2KeyTyped

    private void numcontrl3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numcontrl3KeyTyped
        ...
        try {
            ...
            if (numcontrl3.getText().length() == limitepromedio) {
                evt.consume();
                getToolkit().beep();
                JOptionPane.showMessageDialog(null, "Este Campo Solo Acepta Una Longitud De 2 Caracteres", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
    ...
    }//GEN-LAST:event_numcontrl3KeyTyped

    private void numcontrl1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numcontrl1KeyTyped
        try {

            if (numcontrl1.getText().length() == limiteemail) {
                evt.consume();
                getToolkit().beep();
                JOptionPane.showMessageDialog(null, "Este Campo Solo Acepta Una Longitud De 30 Caracteres", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
